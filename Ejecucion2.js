...
function JUEGOlvl2() {
  function Tiempo_Disminurlvl2() {
    ...
    if (Tiempolvl2 == 0) {
      ...
      Puntajelvl2 = 0;
      alert(
        "El tiempo se agotó, lo lamento, de seguro lo lograrás para la siguiente"
      );
    }
  }
  ...
  document
    .getElementById("Meteioritolvl2")
    .addEventListener("mouseover", Aumentar_Puntoslvl2);
  document
    .getElementById("Meteiorito2lvl2")
    .addEventListener("mouseover", Aumentar_Puntoslvl2);
  document
    .getElementById("Meteiorito3lvl2")
    .addEventListener("mouseover", Aumentar_Puntoslvl2);
  ...
  document
    .getElementById("Meteioritolvl2")
    .addEventListener("mouseover", Explulsarlvl2);
  document
    .getElementById("Meteiorito2lvl2")
    .addEventListener("mouseover", Explulsar2lvl2);
  document
    .getElementById("Meteiorito3lvl2")
    .addEventListener("mouseover", Explulsar3lvl2);
  ...
  function perdistelvl2() {
    if (
      document.getElementById("Meteioritolvl2").offsetLeft > 630 ||
  ...
  function PAUSElvl2() {
    ...
    if (Activolvl2 == 1) {
      ...
      function Metiorito_detenerlvl2() {
        ...
        document.getElementById("Meteioritolvl2").style.top =
          document.getElementById("Meteioritolvl2").offsetTop + "px";
        document.getElementById("Meteiorito2lvl2").style.top =
          document.getElementById("Meteiorito2lvl2").offsetTop + "px";
        document.getElementById("Meteiorito3lvl2").style.top =
          document.getElementById("Meteiorito3lvl2").offsetTop + "px";
      }
